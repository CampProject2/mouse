        ...
        if(turn==1) {
            ...
            if(turn == 1) {
                ...
                val Request2 = Request.Builder()
                    .url("https://854c-192-249-19-234.ngrok-free.app/yourhand")
                    .post(requestBody)
                    .build()
...
//        Log.d("hshshs", o_remain.toString())
    ...
    private fun guess(pos: Int) {
        //다이얼로그 띄우기
        val customDialog = CustomDialog1(this, this@GameActivity2)
        customDialog.show()
        if((ohand[pos] / 2) == gNum) {
            //yourhand update
            down[ohand[pos]] = 1
            ...
            val request = Request.Builder()
                .url("https://854c-192-249-19-234.ngrok-free.app/correct")
                .post(requestBody)
                .build()
    ...
    private fun turnchange() {
        ...
        val requestBody = json.toString().toRequestBody("application/json".toMediaType())
        val request = Request.Builder()
            .url("https://854c-192-249-19-234.ngrok-free.app/turnend")
            .post(requestBody)
            .build()
        val client = OkHttpClient()
        client.newCall(request).enqueue(object : Callback {
    ...
    private fun sendmhand(i: Int) {
        ...
        val request = Request.Builder()
            .url("https://854c-192-249-19-234.ngrok-free.app/hand")
    ...
    class CustomDialog1(context: Context, private val gameActivity2: GameActivity2) : Dialog(context) {
        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
    ...
    class CustomDialog2(context: Context, private val gameActivity2: GameActivity2) : Dialog(context) {
        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
            setContentView(R.layout.board)

            val b0 = findViewById<Button>(R.id.b_0)
...
//                        Log.d("hshs", "111")
    ...
    private fun selectCard() {
        val customDialog = CustomDialog2(this, this@GameActivity2)
        customDialog.show()
    }
